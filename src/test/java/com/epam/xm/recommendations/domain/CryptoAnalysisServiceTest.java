...
class CryptoAnalysisServiceTest {
    ...
    void shouldCalculateStatsCorrectly() {
        ...
        List<PricePoint> pricePoints = List.of(
                ...
                new PricePoint(Instant.ofEpochMilli(3000), symbol, new BigDecimal("38000"))
        );
        ...
        BigDecimal expectedRange = new BigDecimal("4000")
                .divide(new BigDecimal("38000"), 4, RoundingMode.HALF_UP);
    ...
    void shouldThrowExceptionWhenSymbolMismatch() {
        List<PricePoint> pricePoints = List.of(
                new PricePoint(Instant.ofEpochMilli(1000), "ETH", new BigDecimal("40000"))
        );
        assertThrows(IllegalArgumentException.class, () -> 
                service.calculateStats("BTC", pricePoints));
    }
}
