 ...
 * <p>
 * The immutable set guarantees thread-safety and constant-time membership checks,
 * which is sufficient for a small, fixed list of supported symbols configured at startup.
 */
public record SetBasedSymbolValidator(Set<String> supportedSymbols) implements SymbolValidator {

    /**
     * Creates a validator from an arbitrary collection by defensively copying it into an immutable set.
     *
